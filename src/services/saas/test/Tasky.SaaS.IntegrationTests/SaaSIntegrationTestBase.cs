...
public abstract class SaaSIntegrationTestBase : IDisposable
{
    protected SaaSWebApplicationFactory Factory { get; }
    protected HttpClient Client { get; }
    protected TestcontainersFixture Fixture { get; }

    protected SaaSIntegrationTestBase(TestcontainersFixture fixture)
    {
        Fixture = fixture;
        Factory = new SaaSWebApplicationFactory(fixture);
